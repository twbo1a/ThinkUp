...
var TU_Update = function() {
											...
											function(event) {
												...
												if (!tu_update.submitting) {
													$('#migration-submit')
															.hide();
													tu_update
															.prependStatus("<span id=\"starting-migration\">Starting database migration...</span>");
	...
	this.submitForm = function() {
		...
		tu_update.prependStatus("Applying database update " + sql_num + " of "
		...
		// if (sql.match(/key/i)) {
		// tu_update
		// .prependStatus("&nbsp; <b>note:</b> Adding an index, this may take
		// some time");
		// }
